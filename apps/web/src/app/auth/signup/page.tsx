...
export default function SignupPage() {
  ...
  const onSubmit = async (data: SignupFormData, event?: React.BaseSyntheticEvent) => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 flex justify-center items-center w-full bg-gradient-to-b from-blue-50 to-white dark:from-slate-950 dark:to-slate-900 px-4">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="md:w-[500px] sm:w-[450px] w-full bg-card sm:p-8 p-5 mx-6 flex flex-col gap-5 border sm:rounded-2xl rounded-xl shadow-lg shadow-blue-500/5">
          <div className="space-y-1 mb-6">
            <h3 className="text-xl font-semibold text-center">Create your account</h3>
            <p className="text-muted-foreground text-sm text-center">Enter your details to create an account</p>
          </div>
