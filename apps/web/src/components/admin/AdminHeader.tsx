        ...
        <div className="flex justify-between items-center gap-5 h-[70px]">
          <div className="flex justify-center items-center">
            ...
            <button onClick={() => setIsSheetOpen(true)} className="xl:hidden">
              <div className="flex flex-col justify-between w-5 h-4 transform transition-all duration-300 origin-center overflow-hidden rotate-180">
                <div className={`bg-[#1e293b] dark:bg-[#e2e8f0] h-0.5 transform transition-all duration-300 origin-left delay-150 ${isSheetOpen && 'rotate-42 w-[11px]'}`}></div>
                <div className={`bg-[#1e293b] dark:bg-[#e2e8f0] h-0.5 w-7 rounded transform transition-all duration-300 ${isSheetOpen && 'hidden'}`}></div>
                <div className={`bg-[#1e293b] dark:bg-[#e2e8f0] h-0.5 transform transition-all duration-300 origin-left delay-150 ${isSheetOpen && '-rotate-43 w-[11px]'}`}></div>
              </div>
            </button>
          </div>
